...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'doctrine.orm.defaults_entity_listener_resolver' => 'getDoctrine_Orm_DefaultsEntityListenerResolverService',
            'doctrine.orm.defaults_entity_manager' => 'getDoctrine_Orm_DefaultsEntityManagerService',
            'doctrine.orm.defaults_listeners.attach_entity_listeners' => 'getDoctrine_Orm_DefaultsListeners_AttachEntityListenersService',
            'doctrine.orm.defaults_manager_configurator' => 'getDoctrine_Orm_DefaultsManagerConfiguratorService',
            'doctrine.orm.validator.unique' => 'getDoctrine_Orm_Validator_UniqueService',
            'doctrine.orm.validator_initializer' => 'getDoctrine_Orm_ValidatorInitializerService',
            'doctrine_cache.providers.doctrine.orm.defaults_metadata_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_DefaultsMetadataCacheService',
            'doctrine_cache.providers.doctrine.orm.defaults_query_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_DefaultsQueryCacheService',
            'doctrine_cache.providers.doctrine.orm.defaults_result_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_DefaultsResultCacheService',
        ...
        $this->aliases = array(
            ...
            'doctrine.orm.defaults_metadata_cache' => 'doctrine_cache.providers.doctrine.orm.defaults_metadata_cache',
            'doctrine.orm.defaults_query_cache' => 'doctrine_cache.providers.doctrine.orm.defaults_query_cache',
            'doctrine.orm.defaults_result_cache' => 'doctrine_cache.providers.doctrine.orm.defaults_result_cache',
            'doctrine.orm.entity_manager' => 'doctrine.orm.defaults_entity_manager',
    ...
    {
        return $this->services['doctrine'] = new \Doctrine\Bundle\DoctrineBundle\Registry($this, array('default' => 'doctrine.dbal.default_connection'), array('defaults' => 'doctrine.orm.defaults_entity_manager'), 'default', 'defaults');
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventListener(array(0 => 'loadClassMetadata'), $this->get('doctrine.orm.defaults_listeners.attach_entity_listeners'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 8889, 'dbname' => 'symfony', 'user' => 'symfony', 'password' => '123123', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }

    /**
     * Gets the 'doctrine.orm.defaults_entity_listener_resolver' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDoctrine_Orm_DefaultsEntityListenerResolverService()
    {
        return $this->services['doctrine.orm.defaults_entity_listener_resolver'] = new \Doctrine\ORM\Mapping\DefaultEntityListenerResolver();
    }

    /**
     * Gets the 'doctrine.orm.defaults_entity_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDoctrine_Orm_DefaultsEntityManagerService()
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/Acme/DemoTwoBundle/Resources/config/doctrine') => 'Acme\\DemoTwoBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Acme\\DemoTwoBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('AcmeDemoTwoBundle' => 'Acme\\DemoTwoBundle\\Entity'));
        $c->setMetadataCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.defaults_metadata_cache'));
        $c->setQueryCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.defaults_query_cache'));
        $c->setResultCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.defaults_result_cache'));
        ...
        $c->setEntityListenerResolver($this->get('doctrine.orm.defaults_entity_listener_resolver'));

        $this->services['doctrine.orm.defaults_entity_manager'] = $instance = \Doctrine\ORM\EntityManager::create($this->get('doctrine.dbal.default_connection'), $c);

        $this->get('doctrine.orm.defaults_manager_configurator')->configure($instance);

        return $instance;
    }

    /**
     * Gets the 'doctrine.orm.defaults_listeners.attach_entity_listeners' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDoctrine_Orm_DefaultsListeners_AttachEntityListenersService()
    {
        return $this->services['doctrine.orm.defaults_listeners.attach_entity_listeners'] = new \Doctrine\ORM\Tools\AttachEntityListenersListener();
    }

    /**
     * Gets the 'doctrine.orm.defaults_manager_configurator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDoctrine_Orm_DefaultsManagerConfiguratorService()
    {
        return $this->services['doctrine.orm.defaults_manager_configurator'] = new \Doctrine\Bundle\DoctrineBundle\ManagerConfigurator(array(), array());
    }
    ...
    /**
     * Gets the 'doctrine_cache.providers.doctrine.orm.defaults_metadata_cache' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultsMetadataCacheService()
    {
        $this->services['doctrine_cache.providers.doctrine.orm.defaults_metadata_cache'] = $instance = new \Doctrine\Common\Cache\ArrayCache();

        $instance->setNamespace('sf2orm_defaults_b429e54dcac0e561a7c261c658b9eddaada2020ab9333e32cd944834eae56e1c');

        return $instance;
    }

    /**
     * Gets the 'doctrine_cache.providers.doctrine.orm.defaults_query_cache' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\Common\Cache\ArrayCache A Doctrine\Common\Cache\ArrayCache instance.
     */
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultsQueryCacheService()
    {
        $this->services['doctrine_cache.providers.doctrine.orm.defaults_query_cache'] = $instance = new \Doctrine\Common\Cache\ArrayCache();
    ...
    /**
     * Gets the 'doctrine_cache.providers.doctrine.orm.defaults_result_cache' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\Common\Cache\ArrayCache A Doctrine\Common\Cache\ArrayCache instance.
     */
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultsResultCacheService()
    {
        $this->services['doctrine_cache.providers.doctrine.orm.defaults_result_cache'] = $instance = new \Doctrine\Common\Cache\ArrayCache();
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.demo_login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/demo/secured/login$'), 'security.firewall.map.context.demo_secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/demo/secured/'), 'security.firewall.map.context.default' => NULL)), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_DefaultService()
    {
        ...
        $g = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $d, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($d, '/home'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
        ...
        $h->setOptions(array('login_path' => '/', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $h->setProviderKey('default');

        $i = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $d, array(), $b);
        $i->setOptions(array('login_path' => '/', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $j = new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '/', false);

        return $this->services['security.firewall.map.context.default'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.in_memory')), 'default', $b, $c), 2 => $g, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, $this->get('security.authentication.session_strategy'), $d, 'default', $h, $i, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($a, $f, 'default', $j, $b), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5648adf1e85b34.75860293', $b, $f), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'default', $j, NULL, NULL, $b, false));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_DemoSecuredAreaService()
    {
        ...
        return $this->services['security.firewall.map.context.demo_secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.in_memory')), 'demo_secured_area', $b, $c), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), $this->get('security.authentication.session_strategy'), $d, 'demo_secured_area', $g, $h, array('check_path' => '_demo_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'demo_secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '_demo_login', false), NULL, NULL, $b, false));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Acme/DemoTwoBundle/Resources/views'), 'AcmeDemoTwo');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('767c1798a500b64653f743145c6084a447046d01');
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/home'), array(0 => 'ROLE_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/transacciones'), array(0 => 'ROLE_GERENTE'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/repuestos'), array(0 => 'ROLE_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/ventas'), array(0 => 'ROLE_ADMIN'), NULL);
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $c, 'demo_secured_area', $b, true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $c, 'default', $b, true), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5648adf1e85b34.75860293')), true);
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('default', '/logout', 'logout', '_csrf_token', NULL);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_USER'), 'ROLE_GERENTE' => array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN', 2 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    protected function getSecurity_User_Provider_Concrete_InMemoryService()
    {
        ...
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('raul', 'tecnoslarioja', array(0 => 'ROLE_GERENTE')));
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('dante', '450051', array(0 => 'ROLE_ADMIN')));
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('tecnos', 'peron1049', array(0 => 'ROLE_ADMIN')));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AcmeDemoTwoBundle' => 'Acme\\DemoTwoBundle\\AcmeDemoTwoBundle',
            ...
            'secret' => '767c1798a500b64653f743145c6084a447046d01',
            'locale' => 'en',
            ...
            'kernel.secret' => '767c1798a500b64653f743145c6084a447046d01',
            ...
            'doctrine.entity_managers' => array(
                'defaults' => 'doctrine.orm.defaults_entity_manager',
            ),
            'doctrine.default_entity_manager' => 'defaults',
